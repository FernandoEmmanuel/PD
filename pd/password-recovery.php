...
if (isset($_POST['resetpassword'])) {
    ...
    $ret = mysqli_query($con, "call sp_userpwdrecoveryvalidation('$lname','$email')");
    $result = mysqli_num_rows($ret);
    if ($result == 0) {

        echo "<script>alert('Last Name or Email id is invalid');</script>";
    } else {
        $ret->close();
        $con->next_result();
        $ret = mysqli_query($con, "call sp_userpasswordrecovery('$lname','$email','$password','$updatetTime')");
        if ($ret) {
...
<head>
    ...
    <title>Omlympic Streaming</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h5 style="color:blue">Olympic Streaming</h5>
